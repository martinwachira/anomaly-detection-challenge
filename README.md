# Overview
We will provide you with a CSV file `[download and unzip anomalies.zip]` available from this repository. You are expected to do process the file identify anomalies in the data set. 
