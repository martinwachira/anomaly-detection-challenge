# Overview
We will provide you with a CSV file `[download and unzip anomalies.zip]` at a location we will announce at the time of the challenge. You are expected to do process the file identify anomalies in the data set. 
